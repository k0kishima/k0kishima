...
| [machine_learning_hands_on](https://github.com/k0kishima/crossword_brain_training) | 機械学習の自習用リポジトリ（テーマを競馬予想としてロジスティック回帰を行う） | Pythonでの実装（モデル実装や、スクレイピング、Pandasによるデータ分析等） |                                                            |
